...
export function ContactForm() {
  ...
  return (
    <section className="section bg-gradient-to-b from-white to-secondary/50 overflow-hidden">
      <div className="container max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="lg:col-span-1">
            <ScrollReveal>
              <div className="bg-white rounded-xl shadow-medium p-8 hover:shadow-lg transition-shadow duration-300 transform h-full">
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex justify-center mt-8">
                      <Button 
                        type="submit" 
                        variant="accent" 
                        className="px-10 py-6 text-lg hover:scale-105 transition-transform shadow-md hover:shadow-lg animate-pulse-glow"
                        size="lg"
                      >
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <ScrollReveal direction="left" delay="medium">
              <div className="bg-white rounded-xl shadow-medium p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="rounded-lg overflow-hidden shadow-soft h-[260px] hover:shadow-medium transition-shadow duration-300">
                  <iframe 
